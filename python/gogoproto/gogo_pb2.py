...
goproto_getters_all = _descriptor.FieldDescriptor(
  name='goproto_getters_all', full_name='gogoproto.goproto_getters_all', index=3,
...
goproto_enum_prefix_all = _descriptor.FieldDescriptor(
  name='goproto_enum_prefix_all', full_name='gogoproto.goproto_enum_prefix_all', index=4,
...
goproto_stringer_all = _descriptor.FieldDescriptor(
  name='goproto_stringer_all', full_name='gogoproto.goproto_stringer_all', index=5,
...
verbose_equal_all = _descriptor.FieldDescriptor(
  name='verbose_equal_all', full_name='gogoproto.verbose_equal_all', index=6,
...
face_all = _descriptor.FieldDescriptor(
  name='face_all', full_name='gogoproto.face_all', index=7,
...
gostring_all = _descriptor.FieldDescriptor(
  name='gostring_all', full_name='gogoproto.gostring_all', index=8,
...
populate_all = _descriptor.FieldDescriptor(
  name='populate_all', full_name='gogoproto.populate_all', index=9,
...
stringer_all = _descriptor.FieldDescriptor(
  name='stringer_all', full_name='gogoproto.stringer_all', index=10,
...
onlyone_all = _descriptor.FieldDescriptor(
  name='onlyone_all', full_name='gogoproto.onlyone_all', index=11,
...
equal_all = _descriptor.FieldDescriptor(
  name='equal_all', full_name='gogoproto.equal_all', index=12,
...
description_all = _descriptor.FieldDescriptor(
  name='description_all', full_name='gogoproto.description_all', index=13,
...
testgen_all = _descriptor.FieldDescriptor(
  name='testgen_all', full_name='gogoproto.testgen_all', index=14,
...
benchgen_all = _descriptor.FieldDescriptor(
  name='benchgen_all', full_name='gogoproto.benchgen_all', index=15,
...
marshaler_all = _descriptor.FieldDescriptor(
  name='marshaler_all', full_name='gogoproto.marshaler_all', index=16,
...
unmarshaler_all = _descriptor.FieldDescriptor(
  name='unmarshaler_all', full_name='gogoproto.unmarshaler_all', index=17,
...
sizer_all = _descriptor.FieldDescriptor(
  name='sizer_all', full_name='gogoproto.sizer_all', index=18,
...
goproto_enum_stringer_all = _descriptor.FieldDescriptor(
  name='goproto_enum_stringer_all', full_name='gogoproto.goproto_enum_stringer_all', index=19,
...
enum_stringer_all = _descriptor.FieldDescriptor(
  name='enum_stringer_all', full_name='gogoproto.enum_stringer_all', index=20,
...
unsafe_marshaler_all = _descriptor.FieldDescriptor(
  name='unsafe_marshaler_all', full_name='gogoproto.unsafe_marshaler_all', index=21,
...
unsafe_unmarshaler_all = _descriptor.FieldDescriptor(
  name='unsafe_unmarshaler_all', full_name='gogoproto.unsafe_unmarshaler_all', index=22,
...
goproto_extensions_map_all = _descriptor.FieldDescriptor(
  name='goproto_extensions_map_all', full_name='gogoproto.goproto_extensions_map_all', index=23,
...
goproto_unrecognized_all = _descriptor.FieldDescriptor(
  name='goproto_unrecognized_all', full_name='gogoproto.goproto_unrecognized_all', index=24,
...
gogoproto_import = _descriptor.FieldDescriptor(
  name='gogoproto_import', full_name='gogoproto.gogoproto_import', index=25,
...
goproto_getters = _descriptor.FieldDescriptor(
  name='goproto_getters', full_name='gogoproto.goproto_getters', index=26,
...
goproto_stringer = _descriptor.FieldDescriptor(
  name='goproto_stringer', full_name='gogoproto.goproto_stringer', index=27,
...
verbose_equal = _descriptor.FieldDescriptor(
  name='verbose_equal', full_name='gogoproto.verbose_equal', index=28,
...
face = _descriptor.FieldDescriptor(
  name='face', full_name='gogoproto.face', index=29,
...
gostring = _descriptor.FieldDescriptor(
  name='gostring', full_name='gogoproto.gostring', index=30,
...
populate = _descriptor.FieldDescriptor(
  name='populate', full_name='gogoproto.populate', index=31,
...
stringer = _descriptor.FieldDescriptor(
  name='stringer', full_name='gogoproto.stringer', index=32,
...
onlyone = _descriptor.FieldDescriptor(
  name='onlyone', full_name='gogoproto.onlyone', index=33,
...
equal = _descriptor.FieldDescriptor(
  name='equal', full_name='gogoproto.equal', index=34,
...
description = _descriptor.FieldDescriptor(
  name='description', full_name='gogoproto.description', index=35,
...
testgen = _descriptor.FieldDescriptor(
  name='testgen', full_name='gogoproto.testgen', index=36,
...
benchgen = _descriptor.FieldDescriptor(
  name='benchgen', full_name='gogoproto.benchgen', index=37,
...
marshaler = _descriptor.FieldDescriptor(
  name='marshaler', full_name='gogoproto.marshaler', index=38,
...
unmarshaler = _descriptor.FieldDescriptor(
  name='unmarshaler', full_name='gogoproto.unmarshaler', index=39,
...
sizer = _descriptor.FieldDescriptor(
  name='sizer', full_name='gogoproto.sizer', index=40,
...
unsafe_marshaler = _descriptor.FieldDescriptor(
  name='unsafe_marshaler', full_name='gogoproto.unsafe_marshaler', index=41,
...
unsafe_unmarshaler = _descriptor.FieldDescriptor(
  name='unsafe_unmarshaler', full_name='gogoproto.unsafe_unmarshaler', index=42,
...
goproto_extensions_map = _descriptor.FieldDescriptor(
  name='goproto_extensions_map', full_name='gogoproto.goproto_extensions_map', index=43,
...
goproto_unrecognized = _descriptor.FieldDescriptor(
  name='goproto_unrecognized', full_name='gogoproto.goproto_unrecognized', index=44,
...
nullable = _descriptor.FieldDescriptor(
  name='nullable', full_name='gogoproto.nullable', index=45,
...
embed = _descriptor.FieldDescriptor(
  name='embed', full_name='gogoproto.embed', index=46,
...
customtype = _descriptor.FieldDescriptor(
  name='customtype', full_name='gogoproto.customtype', index=47,
...
customname = _descriptor.FieldDescriptor(
  name='customname', full_name='gogoproto.customname', index=48,
...
jsontag = _descriptor.FieldDescriptor(
  name='jsontag', full_name='gogoproto.jsontag', index=49,
...
moretags = _descriptor.FieldDescriptor(
  name='moretags', full_name='gogoproto.moretags', index=50,
...
casttype = _descriptor.FieldDescriptor(
  name='casttype', full_name='gogoproto.casttype', index=51,
